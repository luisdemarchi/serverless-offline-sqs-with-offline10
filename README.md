there [is a bug](https://github.com/CoorpAcademy/serverless-plugins/issues/217) in the library and [this pull-request made by rubenkaiser](https://github.com/CoorpAcademy/serverless-plugins/pull/220)
